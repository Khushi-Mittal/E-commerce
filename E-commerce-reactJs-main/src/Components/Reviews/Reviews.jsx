              ...
              {reviews.counts.map((count) => (
                <div key={count.rating} className="flex items-center text-sm">
                  ...
                  <dd className="ml-3 w-10 text-right text-sm tabular-nums text-gray-900">
                    {reviews.totalCount===0 ? 0 :Math.round((count.count / reviews.totalCount) * 100)}%
                  </dd>
                </div>
              ))}
            </dl>
            ...
            <div className="-my-12 divide-y divide-gray-200">
              {reviews.featured.map((review) => (
                <div key={review.id} className="py-12">
                  <div className="flex items-center">
                    {review.displayPicture ?<img src={review.displayPicture} alt={`${review.userName}.`} className="h-12 w-12 rounded-full" />:<UserIcon className="h-12 w-12 rounded-full" /> }
