...
export default function AdminProductList() {
  ...
  useEffect(() => {
    ...
    dispatch(fetchAllProductsFilterAsync({sort,filter,pagination}));
  }, [sort,filter,page]);
  ...
  return (
    <div className="flex items-center justify-between border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
      ...
      <div
              ...
              className="relative cursor-pointer inline-flex items-center rounded-l-md px-2 py-2 text-gray-800 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
            >
        ...
        <div
              ...
              className="relative cursor-pointer inline-flex items-center rounded-r-md px-2 py-2 text-gray-800 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0"
            >
              <span>Next</span>
      ...
      {Array.from({length:Math.ceil(totalItems/ITEMS_PER_PAGE)}).map((el,idx)=><div
              onClick={()=>{handlePage(idx+1)}}
              key={idx}
              aria-current="page"
              className={`relative z-10 inline-flex items-center
               ${idx+1===page?"bg-indigo-600 text-white":"text-gray-400"} px-4 py-2 text-sm font-semibold
      ...
      <div className="bg-white">
        <div className="mx-auto max-w-2xl px-4 py-4 sm:px-6 sm:py-4 lg:max-w-7xl lg:px-8">
            <Link to="/admin/product-form">
                <button className="rounded-md bg-green-600 text-white py-1 px-2">Add Product</button>
            </Link>
          <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
            {products.map((product) => (
              ...
              >
                ...
                <Link to={"/admin/product/edit/"+product.id} className="">
                <button className="rounded-md bg-indigo-600 text-white mt-5 py-1 px-2">Edit Product</button>
               </Link>
              </div>
